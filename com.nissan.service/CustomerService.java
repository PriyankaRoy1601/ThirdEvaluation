...
public class CustomerService implements ICustomerService {
	...
	@Override
	public List<Customer> withdraw(long accno, double money) {
		// TODO Auto-generated method stub
		if (validation.ValidBalance(String.valueOf(money)) && validation.ValidNumber(String.valueOf(accno))) {
			customer1=customerRepo.findById(accno)
					.orElseThrow(() -> new RuntimeException("Customer not found for account no." + accno));
			if (money > customer1.getBalance() - customer1.getMinBalance()) {
				money = customer1.getBalance() - money;
